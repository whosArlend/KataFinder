...
async function runSearch(rawQuery) {
  ...
  if (!query) {
    ...
    resultCountLabel.textContent = "Silakan ketik awalan kata.";
  ...
  if (!firstLetter) {
    ...
    resultCountLabel.textContent = "Gunakan awalan huruf A-Z.";

    renderInfo("Awali pencarian dengan huruf A-Z.");
  ...
  if (!datasetCache.has(firstLetter) && !datasetLoadPromises.has(firstLetter)) {
    ...
    resultCountLabel.textContent =
      `Memuat dataset huruf "${firstLetter.toUpperCase()}"...`;
  ...
  if (datasetLoadErrors.has(firstLetter)) {
    ...
    resultCountLabel.textContent = "Gagal memuat dataset.";

    renderInfo("Dataset tidak tersedia.");
  ...
  resultCountLabel.textContent =
    `Ditemukan ${matches.length} kata (maks ${MAX_RESULTS}).`;
